return {
    {
        ...
        config = function()
            ...
            vim.api.nvim_set_hl(0, "BlinkCmpSel", { bg = "#44475A", fg = "#f8f8f2", bold = true })
            vim.api.nvim_set_hl(0, "CmpItemSel", { bg = "#44475A", fg = "#f8f8f2", bold = true })
    ...
    -- },
    --{
    --    -- https://github.com/santos-gabriel-dario/darcula-solid.nvim/tree/main
    --    "doums/darcula",
    --    lazy = false,
    --    priority = 1000,
    --    config = function()
